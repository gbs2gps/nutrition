...
<head>
    ...
    <link rel="stylesheet" href="admin.css">
        ...
        <div class="logo-dark">Recipes</div>
...
<form name="mainForm" action="recipes.php" method="post">
  ...
  <div class="row mb-3 mx-3">    
    <input type="submit" value="Add" name="btnAction" class="button-uva" 
           title="Insert a Recipe" />
    <input type="submit" value="Confirm update" name="btnAction" class="button-orange" 
           title="Update a Recipe" />  
  </div>  

</form>
<form name="mainsForm" action="recipes.php" method="post">
  <div class="row mb-3 mx-3">
    RecipeID:
  ...
  <div class="row mb-3 mx-3">    
    <input type="submit" value="Search" name="btnAction" class="button-uva" 
           title="Search" /> 
  </div>  
